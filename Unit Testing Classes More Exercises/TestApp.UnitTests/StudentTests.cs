...
public class StudentTests
{
    ...
    public void Test_AddAndGetByCity_ReturnsStudentsInCity_WhenCityExists()
    {
        ...
        //Arrange
        string[] students1 = { "John Doe 25 Sofia", "Jane Smith 22 Varna", "Alice Johnson 20 Sofia" };

        string expected1 = $"John Doe is 25 years old.{Environment.NewLine}Alice Johnson is 20 years old.";

        //Act

        string result = this._student.AddAndGetByCity(students1,"Sofia");
    ...
    public void Test_AddAndGetByCity_ReturnsEmptyString_WhenCityDoesNotExist()
    {
        ...
        //// Act
        //string result = this._student.AddAndGetByCity(students, "Mezdra");
